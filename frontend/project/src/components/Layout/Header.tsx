...
const Header: React.FC<HeaderProps> = ({ onToggleSidebar, isSidebarCollapsed }) => {
  ...
  return (
    <header className="bg-white shadow-sm border-b border-beige-200 sticky top-0 z-40">
      <div className="flex justify-between items-center h-16 px-4">
        <div className="flex items-center space-x-4">
          <button
            onClick={onToggleSidebar}
            className="p-2 rounded-lg text-brown-600 hover:bg-beige-100 transition-colors"
          >
            {isSidebarCollapsed ? (
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="flex items-center space-x-1 px-3 py-2 text-brown-600 hover:text-brown-800 hover:bg-beige-100 rounded-md transition-colors"
          >
